...
<center><a href=""><img src="_img/nhanes_apple_color_tagline.png"></a></center>
...
Additionally, with my newfound goal, I decided to generate a dataset using primarily datasets from the `rnhanesdata` package as well as some additional factors available from NHANES. Detail of how I processed my final dataset, `nhanes_df`, can be found [here](./data_generation.html)
...
You can check my [report](./report.html) to see how I've combined both `tidyverse` and `tidymodels` techniques to answer my project questions!
...
You can check my [report](./report.html) to see how I utilized sub-sampling methods, obtained these alternate metrics, and evaluated them to arrive at my final model.
