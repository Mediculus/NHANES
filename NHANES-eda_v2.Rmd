...
We then evaluate from the remaining `r nrow(na_check_df)` variables and felt that `NA` amount that is >`r 100*((7455-1000)/7455)`% would not be a good representative of the variable. Therefore, we filtered all those that have values greater than `r 7455*(7455-1000)/7455`. 
